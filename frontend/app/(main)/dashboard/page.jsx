          ...
          <section className="mb-24 relative">
            ...
            >
              <div className="relative bg-white border-2 border-stone-900 overflow-hidden hover:border-orange-600 hover:shadow-lg transition-all duration-300 group cursor-pointer ">
                <div className="grid md:grid-cols-2 gsp-0">
                  ...
                  <div className="p-8 md:p-12 flex flex-col justify-center">
                    <div className="flex flex-wrap gap-2 mb-6">
                      <Badge
                        variant="outline"
                        className={
                          "border-2 border-orange-600 text-orange-700 bg-orange-50 font-bold"
                        }
                      >
                      ...
                      <Badge
                        variant="outline"
                        className={
                          "border-2 border-stone-900 text-stone-700 bg-stone-50 font-bold"
                        }
                      >
